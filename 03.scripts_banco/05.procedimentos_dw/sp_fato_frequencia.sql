...
BEGIN
	...
	BEGIN
		...
		IF (@ID_TEMPO IS NULL) 
		BEGIN
			INSERT INTO TB_VIO_FREQUENCIA
			VALUES (@DATA_CARGA, @DT_FREQUENCIA, @COD_CLIENTE, getdate(), 'ID TEMPO INVALIDO')
		END 
		ELSE IF (@ID_CLIENTE IS NULL) 
		BEGIN
			INSERT INTO TB_VIO_FREQUENCIA
			VALUES (@DATA_CARGA, @DT_FREQUENCIA, @COD_CLIENTE, getdate(), 'ID CLIENTE INVALIDO')
		END 
		ELSE
		BEGIN
